...
- **源码运行**（推荐）：`git clone https://github.com/BB20260410/xikely && cd xikely && npm install && npm start`，浏览器开 http://localhost:51735
- **预编译 .app**：v2.0 暂未发布 .app（better-sqlite3 与 Electron 42 native ABI 兼容性等社区修复，源码运行 100% 可用）
- **v1.0.0 / v1.5.0 / v2.0.0 Release Notes**：见 [GitHub Releases](https://github.com/BB20260410/xikely/releases)
...
```bash
git clone <repo> xikely && cd xikely
npm install
